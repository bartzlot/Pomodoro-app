...
class OptionsMenu(ErrorsHandling):
    ...
    def start_options_window(self):
        ...
        options_layout = [[[sg.Text("Default session time(min):", font=('Open Sans Bold', 30), size=(31,1)), sg.Button('', image_data=self.plus_base64, button_color=(sg.theme_background_color(),sg.theme_background_color()), key='DSTP'),
                             sg.Input(self.default_session_time,  text_color='#c3111a',font=('Open Sans Bold', 30), border_width=0, background_color=(sg.theme_background_color()),size=(2,5), expand_y=True,key='DST'), sg.Button('', image_data=self.minus_base64, button_color=(sg.theme_background_color(),sg.theme_background_color()), border_width=0, key='DSTM')]],
                            [[sg.Text("Default break time(min):", font=('Open Sans Bold', 30), size=(31,1)), sg.Button('', image_data=self.plus_base64, button_color=(sg.theme_background_color(),sg.theme_background_color()), border_width=0,  key='DBTP'),
                               sg.Input(self.default_break_time, text_color='#c3111a',font=('Open Sans Bold', 30), border_width=0, background_color=(sg.theme_background_color()),size=(2,5), expand_y=True,key='DBT'), sg.Button('', image_data=self.minus_base64, button_color=(sg.theme_background_color(),sg.theme_background_color()), border_width=0,  key='DBTM')]],
                            [[sg.Text("Default big break time(min):", font=('Open Sans Bold', 30), size=(31,1)), sg.Button('', image_data=self.plus_base64, button_color=(sg.theme_background_color(),sg.theme_background_color()), border_width=0, key='DBBTP'),
                               sg.Input(self.default_big_break_time, text_color='#c3111a',font=('Open Sans Bold', 30), border_width=0, background_color=(sg.theme_background_color()),size=(2,5), expand_y=True,key='DBBT'), sg.Button('', image_data=self.minus_base64, button_color=(sg.theme_background_color(),sg.theme_background_color()), border_width=0, key='DBBTM')]],
                            [[sg.Text("Default sessions count before big break:", font=('Open Sans Bold', 30), size=(31,1)), sg.Button('', image_data=self.plus_base64, button_color=(sg.theme_background_color(),sg.theme_background_color()), border_width=0, key='DBBCP'),
                               sg.Input(self.default_big_break_count, text_color='#c3111a',font=('Open Sans Bold', 30), border_width=0, background_color=(sg.theme_background_color()),size=(2,5), expand_y=True,key='DBBC'), sg.Button('', image_data=self.minus_base64, button_color=(sg.theme_background_color(),sg.theme_background_color()), border_width=0,  key='DBBCM')]],
...
class TimerMenu(OptionsMenu):
    cancel_base64 = b''
    session_title = ""
    ...
    def start_timer_menu(self):
        ...
        layout = [  [sg.Text("Session title:", font=('Open Sans Bold', 30)), sg.InputText(self.session_title, expand_y=True, text_color='#c3111a', background_color=(sg.theme_background_color()), font=('Open Sans Bold', 30), size=(14,2), key='TITLE')],
                    ...
                    border_width=0, key='Hp'), sg.Input(self.hour,key='HOURS', text_color='#c3111a',font=('Open Sans Bold', 30), border_width=0, background_color=(sg.theme_background_color()),size=(2,5), expand_y=True), sg.Button('', image_data=self.minus_base64, button_color=(sg.theme_background_color(),sg.theme_background_color()), border_width=0, key='Hm')],
                    ...
                    border_width=0, key='Mp'), sg.Input(self.hour,key='MINUTES', text_color='#c3111a', font=('Open Sans Bold', 30), border_width=0, background_color=(sg.theme_background_color()),size=(2,5), expand_y=True), sg.Button('', image_data=self.minus_base64, button_color=(sg.theme_background_color(),sg.theme_background_color()), border_width=0, key='Mm')],
                    ...
                    border_width=0, key='Sp'), sg.Input(self.hour,key='SECONDS', text_color='#c3111a', font=('Open Sans Bold', 30), border_width=0, background_color=(sg.theme_background_color()),size=(2,5), expand_y=True), sg.Button('', image_data=self.minus_base64, button_color=(sg.theme_background_color(),sg.theme_background_color()), border_width=0, key='Sm')],
                    [sg.Button('', image_data=self.back_base64, button_color=(sg.theme_background_color(),sg.theme_background_color()), border_width=0, key='BACK'),
                     sg.Text('', size=(28,0)),
...
class TimerWindow(TimerMenu):
    ...
    def start_timer_window(self):
        ...
        layout1 = [
                    ...
                    [sg.Button('', image_data=self.cancel_base64, button_color=(sg.theme_background_color(),sg.theme_background_color()), border_width=0, key='CANCEL')]
                   ]
        
        timer_window = sg.Window('Timer', layout1, element_justification='c')
...
class SessionsMenu(TimerWindow):
    del_base64 = b''
    ...
    def start_sessions_menu(self):
        ...
        sessions_menu_layout = [[table],
                                [sg.Button('', image_data=self.back_base64, button_color=(sg.theme_background_color(),sg.theme_background_color()), border_width=0, key='BACK'),
                                 sg.Text('', size=(31,0)),
                                 sg.Button('', image_data=self.del_base64, button_color=(sg.theme_background_color(),sg.theme_background_color()), border_width=0, key='DELETE')]]
...
class MainMenu(SessionsMenu):  
    ...
    def start_main_menu(self):
        ...
        tm = TimerMenu()
        sm = SessionsMenu()
        main_menu_layout = [[sg.Image(r'C:\Users\barte\Desktop\pomodoro_app\assets\pomodoro.png', key='LOGO')],
        ...
        main_menu_window = sg.Window('Pomodoro App', main_menu_layout, finalize=True, element_justification='c')
        while True:
